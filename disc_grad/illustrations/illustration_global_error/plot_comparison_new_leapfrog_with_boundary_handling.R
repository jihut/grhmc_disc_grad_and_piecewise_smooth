rm(list = ls())
source("disc_grad/illustrations/illustration_global_error/comparison_nr1_leapfrog_with_boundary_handling_trial_nr2.R")
source("disc_grad/illustrations/illustration_global_error/comparison_nr2_leapfrog_with_boundary_handling_trial_nr2.R")
source("disc_grad/illustrations/illustration_global_error/comparison_nr3_leapfrog_with_boundary_handling_trial_nr2.R")

pdf("disc_grad/illustrations/illustration_global_error/base_comparison_plot_new_leapfrog_with_boundary_handling_trial_nr2.pdf", width = 14, height = 7)
...
points(h_vec_c_0_1, leapfrog_nr4_store_error_c_0_1, col = adjustcolor("orange", alpha.f = 1), cex = 2, pch = 3)
...
legend(
  ...
  legend = c(
    ...
    "NRHMC without boundary handling",
    "NRHMC with boundary handling",
...
points(h_vec_c_1, leapfrog_nr4_store_error_c_1, col = adjustcolor("orange", alpha.f = 1), cex = 2, pch = 3)
...
points(h_vec_c_10, leapfrog_nr4_store_error_c_10, col = adjustcolor("orange", alpha.f = 1), cex = 2, pch = 3)
