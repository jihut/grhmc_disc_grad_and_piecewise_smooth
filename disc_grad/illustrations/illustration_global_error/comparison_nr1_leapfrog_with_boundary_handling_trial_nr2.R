...
leapfrog_nr4_store_error_c_1 <- leapfrog_nr4_store_error
leapfrog_nr4_store_matrix_c_1 <- leapfrog_nr4_store_matrix
...
points(h_vec_c_1, leapfrog_nr4_store_error_c_1, col = adjustcolor("orange", alpha.f = 1), cex = 0.25)
