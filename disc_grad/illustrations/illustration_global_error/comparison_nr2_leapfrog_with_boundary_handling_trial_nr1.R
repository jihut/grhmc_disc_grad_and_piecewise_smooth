...
leapfrog_nr2_store_error_c_0_1 <- leapfrog_nr2_store_error
leapfrog_nr2_store_matrix_c_0_1 <- leapfrog_nr2_store_matrix
...
points(h_vec_c_0_1, leapfrog_nr2_store_error_c_0_1, col = adjustcolor("orange", alpha.f = 1), cex = 0.25)
