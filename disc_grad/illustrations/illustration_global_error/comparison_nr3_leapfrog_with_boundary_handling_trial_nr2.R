...
h_vec_c_10 <- h_vec
leapfrog_nr1_store_error_c_10 <- leapfrog_nr1_store_error
leapfrog_nr1_store_matrix_c_10 <- leapfrog_nr1_store_matrix
leapfrog_nr4_store_error_c_10 <- leapfrog_nr4_store_error
leapfrog_nr4_store_matrix_c_10 <- leapfrog_nr4_store_matrix
...
plot(h_vec_c_10, leapfrog_nr1_store_error_c_10, log = "xy", ylim = c(1e-10, 1e-1), 
     ylab = "L2 error at final state", xlab = "h (step size)", main = "c = 10", cex = 0.25,
     col = adjustcolor("black", alpha.f = 1))
points(h_vec_c_10, leapfrog_nr4_store_error_c_10, col = adjustcolor("orange", alpha.f = 1), cex = 0.25)
points(h_vec_c_10, grhmc_nr1_store_error_c_10, col = adjustcolor("red", alpha.f = 1), cex = 0.25)
points(h_vec_c_10, grhmc_nr2_store_error_c_10, col = adjustcolor("blue", alpha.f = 1), pch = 3, cex = 0.25)
lines(h_vec_c_10, 105 * h_vec_c_10 ^ 3, lty = 2, col = "green")
lines(h_vec_c_10, 16 * h_vec_c_10 ^ 2, lty = 2, col = "darkgreen")
legend(
  "bottomright",
  legend = c(
    "Standard leapfrog",
