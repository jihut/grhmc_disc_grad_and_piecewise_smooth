...
h_vec_c_1 <- h_vec
leapfrog_store_error_c_1 <- leapfrog_store_error
leapfrog_store_matrix_c_1 <- leapfrog_store_matrix
...
plot(h_vec_c_1, leapfrog_store_error_c_1, log = "xy", ylim = c(1e-10, 1), ylab = "L2 error at final state", xlab = "h (step size)", main = "c = 1")
...
final_store_matrix_c_1 <- rbind(
  leapfrog_store_matrix_c_1, 
  grhmc_nr1_store_matrix_c_1,
  grhmc_nr2_store_matrix_c_1
)

final_store_matrix_c_1 %>%
