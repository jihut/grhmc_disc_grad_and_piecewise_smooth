...
source("disc_grad/implementation_scripts/VARI/VARI_adaptive_step_grhmc_discontinuous_gradient_transformed_function.R")

VARI_grhmc_discontinuous_gradient_transformed_function <- function(
    model_list, 
    lambda_initial, 
  ...
  adaptive_step_run <- VARI_adaptive_step_grhmc_discontinuous_gradient_transformed_function(
