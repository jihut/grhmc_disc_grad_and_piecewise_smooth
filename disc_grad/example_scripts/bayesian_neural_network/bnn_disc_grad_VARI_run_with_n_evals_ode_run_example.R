...
grhmc_disc_grad_run <- foreach::foreach(l = 1:n_iterations, .combine = "rbind") %dopar% {
  ...
  sink(paste0("disc_grad/example_scripts/bayesian_neural_network/log/log_nr_", l, ".txt"))
  system.time(
...
# saveRDS(grhmc_disc_grad_run, "disc_grad/example_scripts/bayesian_neural_network/bnn_disc_grad_run_VARI_with_n_evals_ode_run_example.RDS")
