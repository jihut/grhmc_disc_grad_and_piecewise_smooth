...
# saveRDS(samples_matrix, "disc_grad/example_scripts/bayesian_neural_network/bayesian_neural_network_with_constrained_outer_weights_store_samples.RDS")
samples_matrix <- readRDS("disc_grad/example_scripts/bayesian_neural_network/bayesian_neural_network_with_constrained_outer_weights_store_samples.RDS")
