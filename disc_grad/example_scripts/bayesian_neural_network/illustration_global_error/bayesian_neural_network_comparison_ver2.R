...
lines(h_vec, 1.2e7 * h_vec ^ 3, lty = 2, lwd = 3, col = "green")
legend(
  "bottomright",
  legend = c(
    "Leapfrog",
...
pdf("disc_grad/example_scripts/section_6/bayesian_neural_network/illustration_global_error/bayesian_neural_network_comparison_plot_ver2.pdf",
