...
hist(beta_nr1, breaks = 100, probability = T, xlim = c(-6, 6), ylim = c(0, 0.5), xlab = expression(beta), main = expression(P(beta == 0) == 0.25))
...
hist(beta_nr2, breaks = 100, probability = T, xlim = c(-6, 6), ylim = c(0, 0.5), xlab = expression(beta), main = expression(P(beta == 0) == 0.50))
...
hist(beta_nr3, breaks = 100, probability = T, xlim = c(-6, 6), ylim = c(0, 0.5), xlab = expression(beta), main = expression(P(beta == 0) == 0.95))
