...
bnn_stan_run <- rstan::stan(
  "disc_grad/example_scripts/section_6/bayesian_neural_network/stan_bnn_constrained_outer_weights.stan",
  data = list(
    n = n, 
    p = ncol(x),
    x = x,
...
saveRDS(bnn_stan_run, "disc_grad/example_scripts/section_6/bayesian_neural_network/stan_identity_run_example.RDS")
